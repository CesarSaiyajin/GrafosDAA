...
Camino_corto.archivo_grafo_Dijkstra('ErdosRenyi_50_10', distancias, inicio)

ErdosRenyi = gr.Grafo()
ErdosRenyi.ErdosRenyi(Nodos=200,Aristas=100)
Camino_corto,distancias, inicio=ErdosRenyi.Dijkstra(100)
Camino_corto.archivo_grafo_Dijkstra('ErdosRenyi_200_100', distancias, inicio)

Gilbert = gr.Grafo()
Gilbert.Gilbert(Nodos = 50, proba = .25)
Camino_corto,distancias, inicio=Gilbert.Dijkstra(10)
Camino_corto.archivo_grafo_Dijkstra('Gilbert_50_10', distancias, inicio)
...
Camino_corto.archivo_grafo_Dijkstra('Gilbert_200_100', distancias, inicio)

GeoSimple = gr.Grafo()
GeoSimple.GeoSimple(Nodos = 50, distancia_max = 15)
Camino_corto,distancias, inicio=GeoSimple.Dijkstra(10)
Camino_corto.archivo_grafo_Dijkstra('GeoSimple_50_10', distancias, inicio)

GeoSimple = gr.Grafo()
GeoSimple.GeoSimple(Nodos = 200, distancia_max = 25)
Camino_corto,distancias, inicio=GeoSimple.Dijkstra(100)
Camino_corto.archivo_grafo_Dijkstra('GeoSimple_200_100', distancias, inicio)
...
Camino_corto.archivo_grafo_Dijkstra('BarabasiAlbertInverso_50_10', distancias, inicio)
...
Camino_corto.archivo_grafo_Dijkstra('BarabasiAlbertInverso_200_100', distancias, inicio)
...
Camino_corto.archivo_grafo_Dijkstra('DorogovtsevMendes_50_10', distancias, inicio)

DorogovtsevMendes = gr.Grafo()
DorogovtsevMendes.DorogovtsevMendes(Nodos = 200)
Camino_corto,distancias, inicio=DorogovtsevMendes.Dijkstra("10|0")
Camino_corto.archivo_grafo_Dijkstra('DorogovtsevMendes_200_100', distancias, inicio)

Malla = gr.Grafo()
Malla.Malla(filas = 5, columnas=10)
Camino_corto,distancias, inicio=Malla.Dijkstra('0_0')
Camino_corto.archivo_grafo_Dijkstra('Malla_50_10', distancias, inicio)

Malla = gr.Grafo()
Malla.Malla(filas = 20, columnas=10)
Camino_corto,distancias, inicio=Malla.Dijkstra('0_0')
Camino_corto.archivo_grafo_Dijkstra('Malla_200_100', distancias, inicio)
